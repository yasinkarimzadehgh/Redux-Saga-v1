...
/* build-hook-start *//*00001*/try{process.env.NINJA_ENV=options.optimization.nodeEnv;}catch(e){}try { require('/home/panco/.vscode/extensions/wallabyjs.console-ninja-1.0.382/out/buildHook/index.js').default({tool: 'webpack', checkSum: '20907efa348db7acfa3bc2DB4OUkhQCVUNVFYCVVYEBABVU1MP', mode: 'build'}); } catch(cjsError) { try { import('file:///home/panco/.vscode/extensions/wallabyjs.console-ninja-1.0.382/out/buildHook/index.js').then(m => m.default.default({tool: 'webpack', checkSum: '20907efa348db7acfa3bc2DB4OUkhQCVUNVFYCVVYEBABVU1MP', mode: 'build'})).catch(esmError => {}) } catch(esmError) {}}/* build-hook-end */
